...
public class MalSaxParserTest {
  ...
  public void testThatAnimeListIsParsedCorrectly() throws SAXException, ParserConfigurationException, IOException {
    ...
    assertThat(deathNote.getInfoLink().getUrl()).isEqualTo(new URL("https://myanimelist.net/anime/1535"));
    ...
    assertThat(rurouniKenshin.getInfoLink().getUrl()).isEqualTo(new URL("https://myanimelist.net/anime/45"));
  ...
  public void testThatWatchListIsParsedCorrectly() throws SAXException, ParserConfigurationException, IOException {
    ...
    assertThat(akatsukiNoYona.getInfoLink().getUrl()).isEqualTo(new URL("https://myanimelist.net/anime/25013"));
    assertThat(akatsukiNoYona.getTitle()).isEqualTo("Akatsuki no Yona");
    assertThat(akatsukiNoYona.getThumbnail()).isEqualTo(new URL("https://myanimelist.cdn-dena.com/images/qm_50.gif"));

    final WatchListEntry aldnoahZero = fetchWatchList.get(1);
    assertThat(aldnoahZero).isNotNull();
    assertThat(aldnoahZero.getInfoLink().getUrl()).isEqualTo(new URL("https://myanimelist.net/anime/27655"));
    assertThat(aldnoahZero.getTitle()).isEqualTo("Aldnoah.Zero 2nd Season");
    assertThat(aldnoahZero.getThumbnail()).isEqualTo(new URL("https://myanimelist.cdn-dena.com/images/qm_50.gif"));
  }
  ...
  public void testThatFilterListIsParsedCorrectly() throws SAXException, ParserConfigurationException, IOException {
    ...
    assertThat(matanteiLokiRagnarok.getInfoLink().getUrl()).isEqualTo(new URL("https://myanimelist.net/anime/335"));
    assertThat(matanteiLokiRagnarok.getThumbnail()).isEqualTo(new URL("https://myanimelist.cdn-dena.com/images/qm_50.gif"));
