...
public class CsvImporterTest {
  ...
  public void testThatAnimeListIsParsedCorrectly() throws SAXException, ParserConfigurationException, IOException {
    ...
    assertThat(bokuDake.getInfoLink().getUrl()).isEqualTo(new URL("https://myanimelist.net/anime/31043"));
    ...
    assertThat(rurouniKenshin.getInfoLink().getUrl()).isEqualTo(new URL("https://myanimelist.net/anime/44"));
  ...
  public void testThatWatchListIsParsedCorrectly() throws SAXException, ParserConfigurationException, IOException {
    ...
    assertThat(deathNoteRewrite.getInfoLink().getUrl()).isEqualTo(new URL("https://myanimelist.net/anime/2994"));
    assertThat(deathNoteRewrite.getThumbnail()).isEqualTo(new URL("https://myanimelist.cdn-dena.com/images/qm_50.gif"));
  ...
  public void testThatFilterListIsParsedCorrectly() throws SAXException, ParserConfigurationException, IOException {
    ...
    assertThat(gintama.getThumbnail()).isEqualTo(new URL("https://myanimelist.cdn-dena.com/images/qm_50.gif"));
