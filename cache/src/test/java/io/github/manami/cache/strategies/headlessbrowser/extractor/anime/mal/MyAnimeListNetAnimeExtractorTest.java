...
public class MyAnimeListNetAnimeExtractorTest {
    ...
    @Test(groups = UNIT_TEST_GROUP, description = "If the url does not match the expected pattern it is being returned unchanged including possible mistakes such as leading spaces.")
