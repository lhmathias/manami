...
public class WatchListEntryTest {
  ...
  public void testValueOfFromNull() {
    ...
    // when
    final WatchListEntry result = WatchListEntry.valueOf(null);
  ...
  public void testValueOfFromAnime() throws MalformedURLException {
    ...
    // when
    final WatchListEntry result = WatchListEntry.valueOf(anime);
  ...
  @Test(groups = UNIT_TEST_GROUP)
  public void testValueOfFromFilterEntry() throws MalformedURLException {
    // given
    ...
    // when
    final WatchListEntry result = WatchListEntry.valueOf(entry);
