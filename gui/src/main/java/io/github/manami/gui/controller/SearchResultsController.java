...
public class SearchResultsController {
  ...
  private void createWatchListEntries() {
    ...
    event.getWatchListSearchResultList().forEach(
        element -> watchListComponents.add(new AnimeGuiComponentsListEntry(element, getPictureComponent(element), getTitleComponent(element))));
  ...
  private void createFilterListEntries() {
    ...
    event.getFilterListSearchResultList().forEach(element -> {
      final AnimeGuiComponentsListEntry animeGuiComponentsListEntry = new AnimeGuiComponentsListEntry(element, getPictureComponent(element),
          getTitleComponent(element));
  ...
  private void createAnimeListEntries() {
    ...
    event.getAnimeListSearchResultList().forEach(
        element -> animeListComponents.add(new AnimeGuiComponentsListEntry(element, getPictureComponent(element), getTitleComponent(element))));
