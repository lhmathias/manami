...
/**
 * Abstract class if an anime result list. The list entries can be customized by overriding the creation methods.
 */
public abstract class AbstractAnimeListController {
  ...
  /**
   * Creates a {@link Button} which adds an entry to the filter list. It is necessary to do it this way, because the action for the {@link Button} has
   * to reference reference the component entry itself.
   *
   * @param componentListEntry {@link AnimeGuiComponentsListEntry} which needs this button.
   * @return The {@link AnimeGuiComponentsListEntry} which was enriched by the {@link Button}.
   */
  ...
  /**
   * Creates a {@link Button} which adds an entry to the watch list. It is necessary to do it this way, because the action for the {@link Button} has
   * to reference reference the component entry itself.
   *
   * @param componentListEntry {@link AnimeGuiComponentsListEntry} which needs this button.
   * @return The {@link AnimeGuiComponentsListEntry} which was enriched by the {@link Button}.
