package io.github.manamiproject.manami.gui.controller.callbacks;
...
/**
 * Callback which is executed in case one of the simple {@link String} based table cells has changed.
 */
