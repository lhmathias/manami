...
/**
 * It's not possible to use constants for the glyphs, because if you try it a glyph is only shown once in the entire GUI. Thats why you have to
 * instantiate each glyph every time.
 */
public class Icons {
